              ...
              {subtasks.map((subtask) => (
                <div key={subtask.id} className="flex items-center gap-2 rounded-md border px-2 py-1">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        <AlertDialogTitle>Remover subtarefa "{subtask.title}"?</AlertDialogTitle>
                        <AlertDialogDescription>A ação não pode ser desfeita.</AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel>Cancelar</AlertDialogCancel>
                        <AlertDialogAction onClick={() => removeSubtask.mutate(subtask.id)}>
                          Remover
                        </AlertDialogAction>
                      </AlertDialogFooter>
                    </AlertDialogContent>
